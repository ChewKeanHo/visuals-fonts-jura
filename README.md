# Jura Font | (Holloway) Chew, Kean Ho's Creative Visuals

[![banner](/Pictures/banner_1200x630.svg)](#)

Jura is a Latin (ID: `*Latn`) with Cyrillic (ID: `*Cyrl`) and Greek (ID: `EL`)
supported Sans Serif font designed by
[The Jura Project Team](https://github.com/ossobuffo/jura). Its design is based
on Google Fonts Improvement project where the typeface has limited scope and
inconsistent proportions across weights based on standard Sans font. Each
character is nicely structured for clean, serious, yet not too formal
expression.
...
```
Title: Jura Font
Creators: The Jura Project Team
Packaged-By: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-fonts-jura
UUID: FC933FF8-1920-4328-B06D-D1905B00D4CF
License: SIL Open Font License (http://scripts.sil.org/OFL)
Repository Made On: 2026-04-19
Repository Made From: Malaysia, South East Asia
Procure: https://github.com/ChewKeanHo/visuals-fonts-jura
```
